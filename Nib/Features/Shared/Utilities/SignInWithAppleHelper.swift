...
private extension SignInWithAppleHelper {
    ...
    private func getGivenNameFromAuthorization(authorization: ASAuthorization) throws -> String? {
        guard let appleIDCredential = authorization.credential as? ASAuthorizationAppleIDCredential else {
            throw SignInWithAppleError.invalidCredential
        }
    ...
    private func getEmailFromAuthorization(authorization: ASAuthorization) throws -> String? {
        guard let appleIDCredential = authorization.credential as? ASAuthorizationAppleIDCredential else {
            throw SignInWithAppleError.invalidCredential
        }

        return appleIDCredential.email
    }
